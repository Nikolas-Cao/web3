...
interface State {
  ...
  iswhitelistAlreadyClaimed: boolean;
...
const defaultState: State = {
  ...
  iswhitelistAlreadyClaimed: false,
...
export default class Dapp extends React.Component<Props, State> {
              ...
              <>
                ...
                {!this.isSoldOut() ?
                  <MintWidget
                    ...
                    whitelistAlreadyClaimed={this.state.iswhitelistAlreadyClaimed}
                  />
                  :
  ...
  private async refreshContractState(): Promise<void>
  {
    this.setState({
      ...
      iswhitelistAlreadyClaimed: await this.contract.whitelistClaimed(this.state.userAddress!)
    });
  }
  ...
  private async initWallet(): Promise<void>
  {
    ...
    } else if (network.chainId === CollectionConfig.local?.chainId) {
      networkConfig = CollectionConfig.local!;
